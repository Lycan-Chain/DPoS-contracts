...
contract StakingAuRaCoins is StakingAuRaBase {
    ...
    function claimReward(
        ...
        IBlockRewardAuRaCoins blockRewardContract = IBlockRewardAuRaCoins(
        ...
        if (_stakingEpochs.length == 0) {
            _stakingEpochs = IBlockRewardAuRa(address(blockRewardContract))
                .epochsPoolGotRewardFor(poolId);
        }
